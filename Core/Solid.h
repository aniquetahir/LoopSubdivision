...
public:
    ...
    */
    ...
    AddedElements edgeSplitGetNewEdges( tEdge e );


    //! Swap an edge to contain alternating vertices
    /*!
      \param e a tEdge to be swapped.
    */
    void edgeSwap( tEdge e );
